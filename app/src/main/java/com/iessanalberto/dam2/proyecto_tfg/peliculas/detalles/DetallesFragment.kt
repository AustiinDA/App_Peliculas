...
class DetallesFragment : Fragment() {
    ...
    private val safeArgs: DetallesFragmentArgs by navArgs()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val epoxyController = DetallesEpoxyController()
//        { actorId ->
...
//        }
        ...
        viewModel.peliculaLiveDataCreditos.observe(viewLifecycleOwner) { creditos ->
