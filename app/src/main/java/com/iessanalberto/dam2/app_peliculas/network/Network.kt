...
import com.iessanalberto.dam2.app_peliculas.AppApplication
...
object Network {
    ...
    private fun getLoggerHttpClient(): OkHttpClient {
        ...
        client.addInterceptor(
            ChuckerInterceptor.Builder(AppApplication.context)
                .collector(ChuckerCollector(AppApplication.context))
